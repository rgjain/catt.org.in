	<div id="aboutus" class="page w1000">
		...
		<div class="content">
			<p>Over a debate of ecology versus economy, we often forget that both the words originate from the Greek term Oikos, meaning home. The relationship between ecology (study of our home environment) and economy (household resource management) is way more complex and inter-related than it seems to be, making it pivotal to draw a parallel between the two in order to reach at a sustainable future.We at CATT, do not consider nature and forests to be commodities that can be bought or sold and then converted to a tourist package, but as a sphere of life intertwining us with the wild. Here at CATT, WE BELIEVE IN CREATING A SAFE HAVEN FOR THE WILD.</p>
			<p>The Conservation Awareness Team is a group of believers, who believes in the greater role the society as a whole and the community as one can play to bring about a much needed difference in this broken and often distributed populace of ours for the greater good of our nation?s majestic forests. It all started off with a small group of professionals coming together to share their common love for the wild which led to the inception of the Conservation Awareness Team Trust (CATT) as a not for profit organization.</p>
			...
			<div class="team-members">
				<ul>
					...
					<li>
						...
						<div><strong>Dattatreya Ghosh</strong><br /> City Director</div>
						<p><a href="mailto:dattatreyaghosh@gmail.com">dattatreyaghosh@gmail.com</a></p>
						<p>9845105201</p>
					</li>
					...
					<li>
						...
						<div><strong>Shyam G Karthachira</strong><br /> Trustee</div>
						<p><a href="mailto:shyamganeshk@gmail.com">shyamganeshk@gmail.com</a></p>
						<p>9845404911</p>
					</li>

					<li>
						<img src="assets/images/profile/team/pratap.png" alt="Pratap Sikdar">
						<div><strong>Pratap Sikdar</strong><br /> Trustee</div>
