	<div id="wildindia" class="page w1000 team-members">
		<h1>WILD INDIA</h1>
		<div class="content">
			<div class="tabs" >
				<ul>
			...
			<div class="tab-content" >
				<ul>
					<li>
						<h3><a href="http://bnhs.org/bnhs/" >Bombay Natural History Society</a></h3>
						<div>
							 BNHS-India, a pan-India wildlife research organization, has been promoting the cause of nature conservation for the past 131 years, since 1883.
						</div>
					</li>
					<li>
						<h3><a href="http://www.wti.org.in/" >WTI - Wildlife Trust of India</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.bagh.org/" >The BAGH foundation</a></h3>
						<div>
							 Bagh is a not-for-profit national wildlife conservation organisation, established in 2012 by noted conservationist and writer Prerna Singh Bindra (prernabindra.com). Bagh's primary mission is to conserve India's wildlife and wild habitats through policy and legal reform, the promotion of education and awareness, and by supporting effective action on the ground.
						</div>
					</li>
					<li>
						<h3><a href="http://www.atree.org/" >ATREE - Ashoka Trust For Research in Ecology and Environment</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.tigerwatch.net/" >Tiger Watch</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.naturemates.org/" >Nature Mates Nature Club</a></h3>
						<div>
							A bunch of crazy people from different fields of life gathered together, despite their jobs, to meet in an organization for the same passion and dream. They all love the same goal to serve the Nature and causes of her. Yes, we are Crazy in the eternal love to save our natural resources, we are passionate about conservational efforts, we thus made Nature as our companion for ever. We are NATURE MATES!
						</div>
					</li>
					<li>
						<h3><a href="http://www.corbettfoundation.org" >Corbett Foundation</a></h3>
						<div>
							The Corbett Foundation was established by Mr. Dilip D. Khatau, a former Member of the National Board for Wildlife in India and a Member of the Indian Wildlife Business Council of the Confederation on Indian Industry, on April 22, 1994. TCF is a charitable trust, a non-profit and a non-governmental organisation that is fully dedicated to the conservation of wildlife. Apart from being a member of the International Union for the Conservation of Nature (IUCN) and a Member of the Global Tiger Forum, TCF is also an activity partner with the United Nations Decade on Biodiversity, The Ramsar Convention and the Born Free Foundation. TCF has been accredited by Credibility Alliance under the Desirable Norms for Voluntary Organisations in India.
						</div>
					</li>
					<li>
						<h3><a href="http://sacon.in/" >SACON - Salim Ali Centre for Ornithology and Natural History</a></h3>
						<div>
							SACON as formally inaugurated on 5th June 1990 and registered as a society under the Society Registration Act  1860. In appreciation of his lifelong services to India's bird life and conservation of natural resources the Salim Ali Centre for Ornithology and Natural History (SACON) was named  after Dr. Salim Ali. SACON was dedicated to the nation on February 11, 2000 by the Honourable Minister for Environment and Forests, Government of India, Mr. T.R. Baalu.
						</div>
					</li>
					<li>
						<h3><a href="http://www.asiannature.org/" >ANCF - Asian Nature Conservation Foundation</a></h3>
						<div>
							Asian Nature Conservation Foundation. ANCF is a small group of conservation scientists, planners, information managers and administrators working together to support the conservation of biological diversity in India. ANCF was established in 1997 as a charitable trust by the eminent conservation scientist, Prof Raman Sukumar, Chair of the Centre for Ecological Sciences, Indian Institute of Science, Bangalore. It is governed by a Board of Trustees chaired by Prof Sukumar. Mr Thomas Mathew, an experienced conservation planner and manager serves as the Executive Director. ANCF has its headquarters at the Innovation Centre office of the Indian Institute of Science, Bangalore. While ANCF is constituted as an independent group of conservation professionals, in implementing its programmes it works closely with Government agencies, sister research and education institutions, civil society groups and community organizations.
						</div>
					</li>
					<li>
						<h3><a href="http://www.anetindia.org/" >ANET - ANDAMAN and NICOBAR ENVIRONMENTAL TEAM</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.geerfoundation.gujarat.gov.in/aboutus.htm" >GEER - Gujarat Ecological Education and Research (GEER) Foundation</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.madrascrocodilebank.org/cms/" >Madras Crocodile Bank </a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.ccmb.res.in/" >CCMB - Centre for Cellular &amp; Molecular Biology: CSIR</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.wpsi-india.org/wpsi/index.php" >WPSI - Wildlife Protection Society Of India</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://wcsindia.org/home/" >WCS - WILDLIFE CONSERVATION SOCIETY India</a></h3>
						<div>
			...
			<div class="tab-content" >
				<ul>
					<li>
						<h3><a href="http://www.iucn.org/" >IUCN</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.rufford.org/" >Rufford</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.wcs.org/" >WCS -Wildlife conservation society </a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.worldwildlife.org/" > World Wildlife Fund </a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.traffic.org/" >TRAFFIC - The wildlife trade monitoring Network</a></h3>
						<div>
							<p>
							...
							<ul>								
								<li>Investigating and analysing wildlife trade trends, patterns, impacts and drivers to provide the leading knowledge base on trade in wild animals and plants;</li>
								<li>Informing, supporting and encouraging action by governments, individually and through inter-governmental cooperation to adopt, implement and enforce effective policies and laws;</li>
								<li>Providing information, encouragement and advice to the private sector on effective approaches to ensure that sourcing of wildlife uses sustainability standards and best practice; </li>
								<li>Developing insight into consumer attitudes and purchasing motivation and guiding the design of effective communication interventions aimed to dissuade purchasing of illicit wildlife goods.</li>
							</ul>
						</div>
					</li>
					<li>
						<h3><a href="http://www.cites.org/" >CITES - Convention on International Trade in Endangered Species </a></h3>
						<div>
							CITES (the Convention on International Trade in Endangered Species of Wild Fauna and Flora) is an international agreement between governments. Its aim is to ensure that international trade in specimens of wild animals and plants does not threaten their survival.
						</div>
					</li>
					<li>
						<h3><a href="http://www.janegoodall.org/" >The Jane Goodall Institute</a></h3>
						<div>
							Our Mission Founded by renowned primatologist Jane Goodall, the Jane Goodall Institute is a global nonprofit that empowers people to make a difference for all living things. Our work builds on Dr. Goodall's scientific work and her humanitarian vision. Specifically, we seek to: Improve global understanding and treatment of great apes through research, public education and advocacy Contribute to the preservation of great apes and their habitats by combining conservation with education and promotion of sustainable livelihoods in local communities Create a worldwide network of young people who have learned to care deeply for their human community, for all animals and for the environment, and who will take responsible action to care for them
						</div>
					</li>
					<li>
						<h3><a href="http://www.ifaw.org/" >IFAW</a></h3>
						<div>
							We rescue individual animals, protect entire populations and preserve precious habitat.
						</div>
					</li>
				</ul>
			</div>			
			<div class="tab-content" >
				<ul>
					<li>
						<h3><a href="https://www.ncbs.res.in/" >NCBS - National Centre for Biological Sciences</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.wii.gov.in/" >WII - wildlife Institute of India</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.iiseradmission.in/" >IISER - Indian Institutes of Science Education and Research </a></h3>
						<div>
					...
					<li>
						<h3><a href="http://ces.iisc.ernet.in/new/" >IISc - Indian institute of science</a></h3>
						<div>
			...
			<div class="tab-content" >
				<ul>
					<li>
						<h3><a href="http://www.yale.edu/" >Yale University</a></h3>
						<div>
							 Yale University comprises three major academic components: Yale College (the undergraduate program), the Graduate School of Arts and Sciences, and the professional schools. In addition, Yale encompasses a wide array of centers and programs, libraries, museums, and administrative support offices. Approximately 11,250 students attend Yale.
						</div>
					</li>
					<li>
						<h3><a href="https://www.duke.edu/" >Duke University</a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.berkeley.edu/" >University of California, Berkeley </a></h3>
						<div>
					...
					<li>
						<h3><a href="http://www.washington.edu/" >The University of Washington</a></h3>
						<div>
